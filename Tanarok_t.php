...
<main>
    ...
    <hr><br>
    <form action="targyHozzaad.php" method="POST">
        <label for="oktatottTargy">Oktatott tárgy:</label>
        <input type="text" name="oktatottTargy" title="Töltsd ki a mezőt! pl.: magyar, töri ..." autocomplete="off"
               style="margin-left: 10px; margin-right: 20px;" required>
